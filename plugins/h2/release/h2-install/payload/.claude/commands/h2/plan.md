---
name: plan
description: harness-helm skill의 h2-plan workflow를 실행합니다. 목표, scope, done 기준을 docs/01_plan 경로로 정리합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-plan` command semantics from the `harness-helm` skill.
