---
name: context
description: harness-helm skill의 h2-context workflow를 실행합니다. 작업 근거 문서와 제외 문서를 선별하여 context pack을 만듭니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-context` command semantics from the `harness-helm` skill.
