---
name: harvest
description: harness-helm skill의 h2-harvest workflow를 실행합니다. docs/_harvest-inbox 입력을 공식 기준 문서 위치로 정리합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-harvest` command semantics from the `harness-helm` skill.
