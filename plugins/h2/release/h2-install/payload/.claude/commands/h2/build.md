---
name: build
description: harness-helm skill의 h2-build workflow를 실행합니다. upstream 코드 작업 결과를 HERA workflow 산출물로 기록합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-build` command semantics from the `harness-helm` skill.
