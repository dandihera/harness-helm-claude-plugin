---
name: compound
description: harness-helm skill의 h2-compound workflow를 실행합니다. 검증된 지식의 promotion candidate를 분류합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-compound` command semantics from the `harness-helm` skill.
