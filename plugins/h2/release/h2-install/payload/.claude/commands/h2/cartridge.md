---
name: cartridge
description: harness-helm skill의 h2-cartridge workflow를 실행합니다. .harness-helm/h2-cartridge.yml 설정에 따라 h2 upstream mapping을 검증하고 effective mapping을 기록합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-cartridge` command semantics from the `harness-helm` skill.
