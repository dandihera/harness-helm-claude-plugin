---
name: report
description: harness-helm skill의 h2-report workflow를 실행합니다. 작업 결과와 검증/승격 후보를 docs/04_report 경로로 정리합니다.
user-invocable: true
argument: optional
---
...
Invoke the `h2-report` command semantics from the `harness-helm` skill.
