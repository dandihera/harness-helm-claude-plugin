---
name: harness-helm
description: Claude Code adapter for harness-helm h2 workflow contracts. Use for h2-context, h2-plan, h2-design, h2-autorun, h2-rewind, h2-analysis, h2-build, h2-test, h2-review, h2-report, h2-compound, h2-harvest, h2-archive, h2-ops, and h2-cartridge while preserving the 0301-core-workflow-spec command semantics, output fields, staging rules, and docs routing.
---
...
- Do not write `runs-summary.md` directly. This file is written exclusively by `harness archive`; missing or incomplete run manifest timing data must block archive instead of being filled manually.
