...
`docs/40_knowledge/conventions/guidelines/h2-canonical-promotion-flow.md`의 압축 runtime snapshot입니다.

전체 canonical 절차는 `docs/40_knowledge/conventions/guidelines/h2-canonical-promotion-flow.md`를 확인합니다.
...
- 목적지 정책을 여기서 재정의하지 않습니다. `20_specs`와 `30_decisions` 구분은 `references/specs-vs-decisions.md`를 사용합니다.
