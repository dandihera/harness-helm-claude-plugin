---
name: h2
description: Short alias skill for harness-helm h2 workflow commands. Use for $h2 context, $h2 plan, $h2 design, $h2 autorun, $h2 rewind, $h2 analysis, $h2 build, $h2 test, $h2 review, $h2 report, $h2 compound, $h2 harvest, $h2 archive, $h2 ops, and $h2 cartridge by delegating to the canonical harness-helm skill semantics.
---
...
- Treat `$h2 context`, `$h2 plan`, `$h2 design`, `$h2 autorun`, `$h2 rewind`, `$h2 analysis`, `$h2 build`, `$h2 test`, `$h2 review`, `$h2 report`, `$h2 compound`, `$h2 harvest`, `$h2 archive`, `$h2 ops`, and `$h2 cartridge` as the matching canonical `h2-*` command ids.
