...
`canonical`은 검증되어 장기 참조 기준이 되는 원본 지식을 뜻한다. `20_specs`와 `30_decisions` 같은 목적지 판단은 `docs/40_knowledge/conventions/guidelines/harness-helm/specs-vs-decisions.md`를 따른다.
