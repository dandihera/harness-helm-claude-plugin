...
confidence: medium
related:
  - docs/40_knowledge/conventions/guidelines/h2-canonical-promotion-flow.md
  - docs/40_knowledge/conventions/guidelines/h2-specs-vs-decisions.md
  - docs/40_knowledge/conventions/guidelines/h2-upstream-selection-and-override.md
source_references:
...
Target project runtime에서 반복적으로 필요한 규칙은 `docs/40_knowledge/conventions/guidelines/`에 공식 기준 지침으로 둔다. Agent가 실행 중 빠르게 확인해야 하는 핵심 규칙은 `.claude/.codex` skill `references/`에 compact snapshot으로 둔다.
...
|---|---|
| `docs/40_knowledge/conventions/guidelines/h2-canonical-promotion-flow.md` | `references/canonical-promotion-flow.md` |
| `docs/40_knowledge/conventions/guidelines/h2-specs-vs-decisions.md` | `references/specs-vs-decisions.md` |
| `docs/40_knowledge/conventions/guidelines/h2-upstream-selection-and-override.md` | `references/upstream-selection-and-override.md` |

`h2-runtime-reference-selection.md` itself is a meta guideline for deciding snapshot scope. It stays as a docs guideline and is not duplicated as a bundled runtime snapshot.
...
5. Mapping 기준 정의 위치는 이 문서(`docs/40_knowledge/conventions/guidelines/h2-runtime-reference-selection.md`)에 둔다.
