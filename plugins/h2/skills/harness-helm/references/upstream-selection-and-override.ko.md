...
`docs/40_knowledge/conventions/guidelines/h2-upstream-selection-and-override.md`의 압축 runtime snapshot입니다.

전체 canonical 절차는 `docs/40_knowledge/conventions/guidelines/h2-upstream-selection-and-override.md`를 확인합니다.
